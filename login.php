...
<head>
  ...
  <title>ចូល / Login — CINÉ MARQUEE</title>
...
<div class="auth-card">
  ...
  <div class="card-body">
    ...
    <form novalidate id="loginForm">
      ...
      <button type="submit" class="btn btn-ticket w-100 khmer">ចូល / Login</button>
    </form>

    <p class="text-center mt-4 mb-0 khmer" style="font-size:.85rem;">
      គណនីថ្មី? <a href="register.php" class="link-gold">ចុះឈ្មោះ</a>
    </p>
